...
public class PasswordResetEndpointsIntegrationTest {
  ...
  public void setUp() throws Exception {
    this.mockMvc = MockMvcBuilders.standaloneSetup(this.passwordResetEndpoints).build();
    this.encodedPassword = PasswordResetEndpointsIntegrationTest.this.passwordEncoder.encode("test123$");
    ...
    Map<String, Object> dbObjectDetails = new HashMap<String, Object>() {{
      ...
      this.put("password", PasswordResetEndpointsIntegrationTest.this.encodedPassword);
  ...
  public void createTokenShouldReturn409WhenAlreadyRequested() throws Exception {
    ...
    Map<String, Object> tokenDetails = new HashMap<String, Object>() {{
      this.put("_id", PasswordResetEndpointsIntegrationTest.this.dbObject.get("email"));
    }};
