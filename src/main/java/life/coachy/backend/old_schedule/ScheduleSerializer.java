...
//    jsonGenerator.writeStringField("creator", old_schedule.getCreator().getIdentifier().toHexString());
//    jsonGenerator.writeStringField("charge", old_schedule.getCharge().getIdentifier().toHexString());
