...
import life.coachy.backend.old_schedule.dto.ScheduleDtoMapperFactory;
...
//    this.userFacade = userFacade;
  ...
  public <S extends AbstractDto> Schedule save(S dto) {
    ...
    String[] chargePermissions = {"old_schedule." + schedule.getIdentifier() + ".read"};
    String[] coachPermissions = {
        "old_schedule." + schedule.getIdentifier() + ".read",
        "old_schedule." + schedule.getIdentifier() + ".update",
        "old_schedule." + schedule.getIdentifier() + ".delete"
    };

//    this.userFacade.addPermissions(old_schedule.getCreator().getIdentifier(), coachPermissions);
//    this.userFacade.addPermissions(old_schedule.getCharge().getIdentifier(), chargePermissions);
...
//    UserDto charge = old_schedule.getCharge();
//    UserDto creator = old_schedule.getCreator();
//
//    this.userFacade.removePermissions(charge.getIdentifier(), old_schedule.getIdentifier());
//    this.userFacade.removePermissions(creator.getIdentifier(), old_schedule.getIdentifier());
